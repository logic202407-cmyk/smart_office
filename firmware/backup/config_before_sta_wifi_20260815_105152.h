// ============================================================
// config.h — 引脚宏定义 + 系统参数定义
// 项目：智慧办公防偷窥人体感知系统
// 状态：引脚已按原理图/网表确认（2026-05-08）
// ============================================================
// 确认来源：Netlist_Schematic1 + 原理图 PinMap
// 网络连接关系：
//   SDA: U1.4 <-> U4.4 <-> U6.2
//   SCL: U1.5 <-> U4.3 <-> U6.5
...
#define RADAR_UART_BAUD  256000  // LD2410B 默认波特率
#define RADAR_UART_RX_BUF 256    // UART 接收缓冲区
#define RADAR_FRAME_TIMEOUT_MS 100  // 雷达帧解析超时 (半包保护, ms)
...
#define OLED_RESET_PIN   -1      // 无独立复位引脚 (由 I2C 总线管理)
// OLED_SCL / OLED_SDA 为 U8g2 构造函数所需别名 (与 PIN_I2C_SCL/PIN_I2C_SDA 相同)
...
// 7. 系统参数 (状态机, 阶段2启用)
// ============================================================
#define NEAR_DIST_CM     150     // "接近" 阈值 (cm)
#define VERY_NEAR_DIST_CM 80     // "非常近" 阈值 (cm)
...
// 8. 串口调试
// ============================================================
#define SERIAL_BAUD      115200  // USB CDC 串口波特率
#define PC_HEARTBEAT_MS  5000    // 定时心跳间隔 (PC 通信)

// EI 实验无线遥测：仅镜像已有 JSONL，USB CDC 串口始终保留。
#define WIFI_TELEMETRY_ENABLED  1
#define WIFI_TELEMETRY_SSID     "SmartOffice-Lab"
#define WIFI_TELEMETRY_PASSWORD "SmartOfficeLab"
#define WIFI_TELEMETRY_PORT     3333

// ============================================================
// 9. LED 闪烁参数 (Phase 1 验证用)
// ============================================================
