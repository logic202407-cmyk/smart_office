...
// Target states.
#define LD2410B_TARGET_NONE       0x00
#define LD2410B_TARGET_MOVING     0x01
...
enum LD2410B_ParserState : uint8_t {
    ...
    PARSER_CFG_WAIT_LEN_L,
    PARSER_CFG_WAIT_LEN_H,
    PARSER_CFG_WAIT_DATA,
    PARSER_CFG_WAIT_04,
...
private:
    ...
    LD2410B_ParserState _state;
    LD2410B_TargetInfo  _info;
